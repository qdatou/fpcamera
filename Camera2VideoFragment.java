...
public class Camera2VideoFragment extends Fragment
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        mTextureView = (AutoFitTextureView) view.findViewById(R.id.texture2);
        mButtonVideo = (ImageButton) view.findViewById(R.id.video);
        mButtonVideo.setOnClickListener(this);
        view.findViewById(R.id.info2).setOnClickListener(this);
        view.findViewById(R.id.preview2).setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.preview2: {
                Intent intent = new Intent(getActivity().getApplicationContext(),PreviewImgActivity.class);
                startActivity(intent);
//                Intent innerIntent = new Intent(Intent.ACTION_GET_CONTENT) ; //"android.intent.action.GET_CONTENT"
////                innerIntent.setType("video/*;image/*"); //查看类型 String IMAGE_UNSPECIFIED = "image/*";
...
//                }
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if(null != data){
            ...
            CustomApplication.setPhotoUri(uri);
            Activity activity = getActivity();
            if (null != activity) {
                getFragmentManager().beginTransaction()
                        .replace(R.id.container, PreviewFragment.newInstance())
